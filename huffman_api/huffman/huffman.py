...
def compress_file(file_path, encoding_table):
    ...
    encoding_table_path = file_name +'_encoded_table.json'
    ...
    with open(encoding_table_path,'w') as encoded_table:
        json.dump(encoding_table, encoded_table)
        
    print(f'Use encoding table to decompress:{encoding_table_path}')


def decompress_file(compressed_file_path,encoding_table_path):
    ...
    with open(encoding_table_path,'r') as file:
        encoding_table=json.load(file)
